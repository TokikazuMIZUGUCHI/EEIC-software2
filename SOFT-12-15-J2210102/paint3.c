...
typedef enum res{ EXIT, LINE, REC, CIRCLE, UNDO, SAVE, LOAD, UNLOAD, CHPEN, UNKNOWN, ERRNONINT, ERRLACKARGS, NOCOMMAND} Result;
...
char *strresult(Result res){
    ...
    case UNLOAD:
    return "history cannot be loaded";
    case CHPEN:
